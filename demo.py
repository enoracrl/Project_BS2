...
if __name__ == "__main__" :
      ...
      input()
      print("Erdös-Rényi random graph with a probability p of 0.5")
      input()
      print(interactome1.graph_ER(0.5))
      input()
      print("Barabasi-Albert random graph with a maximal number of nodes of 10")
      input()
      print(interactome1.graph_BA(15))
      input()
