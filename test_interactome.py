...
class test_results(unittest.TestCase):
    ...
    def test_is_interaction_file(self):
        ...
        self.assertIsNotNone(file1.is_interaction_file())
        ...
        self.assertIsNotNone(file2.is_interaction_file())
    ...
    def test_histogram_degree(self):
        ...
        self.assertIsNone(file1.histogram_degree(1, 2))
